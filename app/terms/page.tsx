  ...
  return (
    <div className={`flex flex-col items-center min-h-screen p-8 md:p-20`}>
      ...
      <div className="items-start">
        <p>By using the website, you agree that your searched books will be sent to Google to help us get the book&apos;s details, though no other information about you will be shared to Google.</p>
