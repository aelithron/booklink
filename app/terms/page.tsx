...
export default function Page() {
  return (
    <div className={`flex flex-col items-center min-h-screen p-8 md:p-20`}>
      ...
      <h1 className="my-4 text-4xl font-semibold">Terms and Privacy</h1>
      <div className="items-start">
        ...
        <p className="mt-2">If you need to remove any content from this site under the Digital Millenium Copyright Act, please send an email to {process.env.NEXT_PUBLIC_DMCA_EMAIL || "(email not available)"} with a link to the infringing page.</p>
      </div>
    </div>
  );
}